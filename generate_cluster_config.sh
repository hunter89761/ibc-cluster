...
### generate cluster2
rm -rf ./chainData_bak/ernest2
evmosd testnet init-files --v 3 -o ./chainData_bak/ernest2 --keyring-backend=test --starting-ip-address 192.167.10.7 --chain-id evmos_9001-1

  for i in {0..2}; do
    APP_TOML="./chainData_bak/ernest2/node$i/evmosd/config/app.toml"
    GENESIS="./chainData_bak/ernest2/node$i/evmosd/config/genesis.json"
    TMP_GENESIS="./chainData_bak/ernest2/node$i/evmosd/config/tmp_genesis.json"
    DATADIR="./chainData_bak/ernest2/node$i/evmosd/data"
